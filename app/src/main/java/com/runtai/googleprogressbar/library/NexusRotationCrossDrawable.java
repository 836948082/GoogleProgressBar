package com.runtai.googleprogressbar.library;
...
import com.runtai.googleprogressbar.R;
        ...
        objectAnimator.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                if (mRotationAngle == 180) {
                    ...
                    objectAnimator.setStartDelay(ANIMATION_START_DELAY * 2);//转完一圈后*2 设置停留时间(有暂停感)
                } else {
